...
var volJournal = journal.NewCSIVolumeJournal(CSIInstanceID)
...
func prepareKrbdFeatureAttrs() (uint64, error) {
	...
	//fmt.Printf()("kernel version is too old: %q", release)
...
//			//fmt.Printf()("stat on %q failed: %v", krbdSupportedFeaturesFile, err)
//
//			return "", err
//		}
...
//		if err != nil {
//			//fmt.Printf()("modprobe failed (%v): %q", err, stderr)
//
//			return "", err
//		}
//	}
...
//			//fmt.Printf()("reading file %q failed: %v", krbdSupportedFeaturesFile, err)
//
//			return "", err
//		}
//		attrs, err := prepareKrbdFeatureAttrs()
//		if err != nil {
//			//fmt.Printf()("preparing krbd feature attributes failed, %v", err)
//
//			return "", err
//		}
//
...
func HexStringToInteger(hexString string) (uint, error) {
	...
	if err != nil {
		fmt.Printf("converting string %q to integer failed: %v", numberStr, err)
...
//			supported = false
//			fmt.Println()(ctx, "krbd feature %q not supported", featureName)
//
//			break
//		}
//	}
...
func flattenClonedRbdImages(
	...
	for _, snapName := range origNameList {
		...
		err = rv.flattenForceRbdImage(ctx)
		if err != nil {
...
func (ri *rbdImage) flattenForceRbdImage(ctx context.Context) error {
	var err error
